...
Experience.create!(name: "Hapuna Beach", pronunciation: "", location: "Kohala", description: "Perhaps the most famous stretch of sand on the Big Island. Hapuna is known for it's stunning white sand, beautiful crystal clear water, and all the people who come to enjoy it. Swimming here is excellent.", length: "3 hours", time: "Before 10 am", info: "There is almost ZERO shade at Hapuna, so bring an umbrella. Swimming is not safe during high-surf periods.", image_url: "http://palekaikoestate.com/wp-content/uploads/2016/09/hapuna.jpg", links: "", lat: -155.8250, lng: 19.9914)
TagExperience.create!(tag_id: 1, experience_id: 13)
TagExperience.create!(tag_id: 2, experience_id: 13)

Experience.create!(name: "Waipi'o Valley", pronunciation: "", location: "Kohala", description: "On the wild north coast of the island you will find one of Hawaii's most beautiful vistas (and that's saying something...) The Waipi'o Valley is a vast verdant land of taro fields, waterfalls, and towering cliffs. This land was particularly special to the ancient Hawaiians, who gathered here on special occasions to bask in the the Waipi'o splendor. The best way to take in the valley is to hike in and spend a night or two camping in the valley. It's as close as you get to experiencing life as ancient Hawaiians did.", length: "Overnight", time: "Any time", info: "You can take a tour or hike into the valley on your own, but be sure to bring bug spray and plenty of water. The hiking can be strenuous.", image_url: "https://www.lovebigisland.com/wp-content/uploads/waipio-valley-black-sand-beach-hawaii.jpg", links: "", lat: -155.5928, lng: 20.1140)
...
Experience.create!(name: "Volcano Winery", pronunciation: "", location: "Kau", description: "This adorable little vineyard in the middle of the Pacific benefits directly from both the altitude provided by the volcano, as well as the minerality of the soil. If you are spending the night in Volcano, this is a wondeful opportunity to get a taste of the local flavor.", length: "1 hour", time: "Evening", info: "Try the Macadamia Nut Honey Wine.", image_url: "https://www.onlyinyourstate.com/wp-content/uploads/2017/04/7.-Volcano-Winery.jpg", links: "", lat: -155.2848, lng: 19.4457)
